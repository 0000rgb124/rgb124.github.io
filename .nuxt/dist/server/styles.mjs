...
export default {
  ...
  "layouts/default.vue": () => import('./_nuxt/default-styles.37713af8.mjs').then(interopDefault),
  "components/babylon.vue": () => import('./_nuxt/babylon-styles.03056add.mjs').then(interopDefault)
}