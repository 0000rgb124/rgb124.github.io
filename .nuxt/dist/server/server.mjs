...
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, toRaw, isReactive, effectScope, markRaw, watch, nextTick, unref, getCurrentScope, onScopeDispose, toRefs, version, shallowRef, Transition, Suspense, provide, useSSRContext, withCtx, createVNode, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia, hot) {
    ...
    pinia = (process.env.NODE_ENV === "test" && activePinia && activePinia._testing ? null : pinia) || currentInstance && inject(piniaSymbol, null);
    if (pinia)
      setActivePinia(pinia);
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.2dfdfdce.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.caf0b615.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.c5bd98c2.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.84c7dc83.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.d5b9b5aa.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default.3f427b3e.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.63c75bd9.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
